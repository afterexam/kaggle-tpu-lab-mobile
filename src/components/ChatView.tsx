...
export const ChatView: React.FC<ChatViewProps> = ({
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: 'assistant',
      content:
        'Hello! I am an LLM deployed on the Kaggle TPU v5e-8 cluster. Once the instance is ready, I will assist you with algorithm design, code authoring, and reasoning analysis with high throughput.',
      timestamp: Date.now(),
    },
  ]);
    ...
    setMessages([
      {
        id: 'init-1',
        role: 'assistant',
        content: 'Session reset. You can start typing or select a prompt preset below.',
        timestamp: Date.now(),
      },
    ]);
  };
                ...
                >
                  ...
                  {isLong && !isExpanded && (
                    ...
                    >
                      ...
                      >
                        <ChevronDown size={12} />
                        <span>Expand remaining {lineCount - 15} lines</span>
                      </button>
                    </div>
                  )}
                </div>
  ...
  const quickPrompts = [
    { label: '⚡ TPU Benchmark', prompt: 'Please provide a Python script to asynchronously benchmark the throughput (tokens/s) of this TPU endpoint.' },
    { label: '💻 vLLM Client', prompt: 'Please provide a minimal working example using the standard OpenAI Python SDK for streaming completions.' },
    { label: '🧠 Architecture', prompt: 'Please explain how TPU v5e-8 Matrix Multiply Units (MXU) and vLLM scheduling optimize memory under long context windows.' },
  ];
  ...
  return (
    <div className="chat-container">
      ...
      <div className="chat-topbar">
        ...
        >
          ...
          <span style={{ fontWeight: 600, color: '#fff' }}>
            {currentEndpoint?.model || 'No TPU Connected'}
          </span>
      ...
      {!isEndpointReady && (
        ...
        >
          <span style={{ color: 'var(--accent-amber)' }}>⚠️ Not connected to a ready TPU v5e-8 endpoint</span>
                ...
                <div className="msg-footer">
                  ...
                  <div className="msg-footer-actions">
                    ...
                    >
                      ...
                      <span>{copiedCode === m.id ? 'Copied' : 'Copy'}</span>
                    </button>
      ...
      {!isAtBottom && (
        <button className="scroll-bottom-btn" onClick={() => scrollToBottom(true)}>
          <ArrowDown size={13} />
          <span>Back to bottom {hasNewUnread && '· New content'}</span>
        </button>
      )}
        ...
        <textarea
          ...
          placeholder={
            isEndpointReady
              ...
              : 'TPU endpoint offline. Tap top pill to configure.'
          }
          value={input}
          ...
          <div className="drawer-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '15px', fontWeight: 700 }}>
                ...
                <span>TPU Endpoint Details & Settings</span>
              </div>
            ...
            {endpoints.length > 1 && (
              <div className="form-group">
                <label className="form-label">Switch Active TPU Node:</label>
                <select
            ...
            {currentEndpoint && (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Served Model Name:</span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px' }}>
                  ...
                  >
                    ...
                    <span>{copiedKey === 'pair' ? 'Copied' : 'Copy URL+Key'}</span>
                  </button>
                  ...
                  >
                    ...
                    <span>{copiedKey === 'env' ? 'Copied' : 'Copy .env Format'}</span>
                  </button>
                </div>
              </div>
            )}
            ...
            <div className="form-group">
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                <input
                  ...
                  readOnly
                  value={currentEndpoint?.baseUrl || 'Not connected'}
            ...
            <div className="form-group">
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                <input
                  className="form-input"
                  readOnly
                  value={currentEndpoint?.apiKey || 'Unassigned'}
                  style={{ fontFamily: 'var(--font-mono)', fontSize: '11px' }}
                />
            ...
            >
              <div style={{ fontSize: '11px', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '4px' }}>
                Custom Base URL Override (Proxy / Self-Hosted Tunnel):
              </div>
              <div style={{ display: 'flex', gap: '6px' }}>
                <input
                  className="form-input"
